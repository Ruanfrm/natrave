...
export function Home() {
    ...
    return (
        <div className="md:h-screen md:h-max-screen bg-red-700 text-white flex flex-col items-center">
            <header className="my-4 flex justify-center container ">
                <img src="/img/logo-fundo-vinho.svg" className="w-40" />
            </header>
    
            <div className="container p-6 flex-1 flex flex-col space-y-6 md:flex-row md:space-y-0 md:space-x-6  md:items-center">
                <div className="md:flex-1 flex justify-center">
                    <img className="w-full max-w-lg" src="/img/img.png"/>
                </div>
